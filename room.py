...
from objects import Chest, Portal,Merchant, Potion
...
class RoomController:
    def __init__(self, game, pos, spawners):
      ...
      self.image = pygame.Surface(((cfg.ROOM_SIZE - 4.2 )* cfg.MEASURE, (cfg.ROOM_SIZE - 4.2) * cfg.MEASURE))
      self.image.fill('red')
  ...
  # loc -> pos
    @property
    def rect(self):
      top = (self.posx+2.1) * cfg.MEASURE
      left = (self.posy+2.1) *cfg.MEASURE
      width = (cfg.ROOM_SIZE - 4.2) * cfg.MEASURE
      height = (cfg.ROOM_SIZE - 4.2) * cfg.MEASURE
...
def create_room(game, posx, posy, doors, content_function=None):
    ...
    if content_function:
      spawners = content_function(game, (posx,posy))
...
def portal(game, pos):
  p1 = Portal(game,(pos[0]+6) * cfg.MEASURE, (pos[1] + 5) * cfg.MEASURE)
  game.sprites.add(p1)
  

def merchant(game, pos):
  m1 = Merchant(game,(pos[0]+6.5) * cfg.MEASURE, (pos[1] + 4) * cfg.MEASURE)
  game.sprites.add(m1)
  path0 = random.choice(cfg.LVL0_WEAPONS)
  path1 = random.choice(cfg.LVL1_WEAPONS)
  path2 = random.choice(cfg.LVL2_WEAPONS)
  p1 = Potion(game,(pos[0]+3.5) * cfg.MEASURE, (pos[1] + 8) * cfg.MEASURE,random.choice(cfg.potions  )) 
  lw0 = LyingWeapon(game,(pos[0]+5.5) * cfg.MEASURE, (pos[1] + 8) * cfg.MEASURE, path0,True)
  lw1 = LyingWeapon(game,(pos[0]+7.5) * cfg.MEASURE, (pos[1] + 8) * cfg.MEASURE, path1,True)
  lw2 = LyingWeapon(game,(pos[0]+9.5) * cfg.MEASURE, (pos[1] + 8) * cfg.MEASURE, path2,True)
  game.sprites.add(p1)
  game.sprites.add(lw0)
  game.sprites.add(lw1)
  game.sprites.add(lw2)
  

def treasure(game, pos):
  ch1 = Chest(game,(pos[0]+6) * cfg.MEASURE, (pos[1] + 6) * cfg.MEASURE,random.randint(0,2))
  game.sprites.add(ch1)
  game.blocks.add(ch1)
  game.lying_weapons.add(ch1)
